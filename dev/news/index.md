...
- [`vec_equal()`](https://vctrs.r-lib.org/dev/reference/vec_equal.md)
  ...
  the fact that attributes are generally viewed as a map rather than an
  ordered list ([\#2156](https://github.com/r-lib/vctrs/issues/2156)).

- Pairlist tags and attribute names are now incorporated during object
  hashing. In practice this can come up when list elements are hashed
  inside functions like
  [`vec_unique()`](https://vctrs.r-lib.org/dev/reference/vec_unique.md)
  ([\#2154](https://github.com/r-lib/vctrs/issues/2154)).
...
- New
  ...
  is not being deprecated, we just no longer feel like it has the best
  name or the most correct API, and all future work will be put into
  improving
  [`list_combine()`](https://vctrs.r-lib.org/dev/reference/list_combine.md).
  [`list_combine()`](https://vctrs.r-lib.org/dev/reference/list_combine.md)
...
- New `slice_value` argument for
  [`vec_assign()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md)
  to optionally slice `value` by `i` before performing the assignment.
  It is an optimized form of `vec_slice(x, i) <- vec_slice(value, i)`
  that avoids materializing `vec_slice(value, i)`
  ([\#2009](https://github.com/r-lib/vctrs/issues/2009)).

- New `.size` argument for
  [`list_of()`](https://vctrs.r-lib.org/dev/reference/list_of.md) that
  can restrict the element size in addition to the element type. For
  example:
...
- The following functions are no longer experimental:
  ...
  - [`vec_group_id()`](https://vctrs.r-lib.org/dev/reference/vec_group.md)
  - [`vec_group_loc()`](https://vctrs.r-lib.org/dev/reference/vec_group.md)
  - [`vec_group_rle()`](https://vctrs.r-lib.org/dev/reference/vec_group.md)
...
- [`vec_assign()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md)
  no longer modifies `POSIXlt` and `vctrs_rcrd` types in place
...
- [`vec_locate_sorted_groups()`](https://vctrs.r-lib.org/dev/reference/vec_locate_sorted_groups.md)
  and
  [`vec_order_radix()`](https://vctrs.r-lib.org/dev/reference/order-radix.md)
...
- [`vec_match()`](https://vctrs.r-lib.org/dev/reference/vec_match.md),
  ...
  [`vec_unique()`](https://vctrs.r-lib.org/dev/reference/vec_unique.md)
  and other functions backed by a dictionary based implementation are
  often significantly faster, depending on the exact inputs used
  ([\#1976](https://github.com/r-lib/vctrs/issues/1976)).

- [`vec_equal()`](https://vctrs.r-lib.org/dev/reference/vec_equal.md)
  now efficiently internally recycles `x` and `y` elements of size 1
...
- [`vec_assign()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md)
  and `vec_slice<-()` now efficiently internally recycle `value` of size
  1.

- [`vec_assign()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md)
  and `vec_slice<-()` are now more efficient with logical `i`
  ([\#2009](https://github.com/r-lib/vctrs/issues/2009)).
...
- Fixed a performance issue with
  [`vec_c()`](https://vctrs.r-lib.org/dev/reference/vec_c.md) and ALTREP
...
- Fixed an issue with
  [`vec_rank()`](https://vctrs.r-lib.org/dev/reference/vec_rank.md) and
...
- New [`vec_run_sizes()`](https://vctrs.r-lib.org/dev/reference/runs.md)
  for computing the size of each run within a vector. It is identical to
  the `times` column from
  [`vec_unrep()`](https://vctrs.r-lib.org/dev/reference/vec-rep.md), but
  is faster if you don’t need the run key
...
- New `sizes` argument to
  ...
  which allows you to partition a vector using an integer vector
  describing the size of each expected slice. It is particularly useful
  in combination with
  [`vec_run_sizes()`](https://vctrs.r-lib.org/dev/reference/runs.md) and
  [`list_sizes()`](https://vctrs.r-lib.org/dev/reference/vec_size.md)
  ([\#1210](https://github.com/r-lib/vctrs/issues/1210),
...
- New
  ...
  validation than
  [`vec_assert()`](https://vctrs.r-lib.org/dev/reference/vec_assert.md)
  and [`vec_is()`](https://vctrs.r-lib.org/dev/reference/vec_assert.md),
  which have been marked as questioning because the semantics of their
  `ptype` arguments are hard to define and can often be replaced by
  [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md) or a
...
- [`vec_is_list()`](https://vctrs.r-lib.org/dev/reference/vec_is_list.md)
  and
  [`vec_check_list()`](https://vctrs.r-lib.org/dev/reference/vec_is_list.md)
...
- [`vec_chop()`](https://vctrs.r-lib.org/dev/reference/vec_chop.md) has
...
- [`vec_identify_runs()`](https://vctrs.r-lib.org/dev/reference/runs.md)
  is now faster when used with data frames
...
- [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
  now consistently falls back to bare data frame in case of incompatible
...
- [`list_of()`](https://vctrs.r-lib.org/dev/reference/list_of.md) was
  relaxed to make it easier to combine. It is now coercible with
  [`list()`](https://rdrr.io/r/base/list.html)
  ([\#1161](https://github.com/r-lib/vctrs/issues/1161)). When
  incompatible
  [`list_of()`](https://vctrs.r-lib.org/dev/reference/list_of.md) types
  are combined, the result is now a bare
  [`list()`](https://rdrr.io/r/base/list.html).

  Following this change, the role of
  [`list_of()`](https://vctrs.r-lib.org/dev/reference/list_of.md) is
  mainly to carry type information for potential optimisations, rather
  than to guarantee a certain type throughout an analysis.
...
- Directed calls to
  [`vec_c()`](https://vctrs.r-lib.org/dev/reference/vec_c.md), like
...
- [`list_unchop()`](https://vctrs.r-lib.org/dev/reference/list_unchop.md)
  no longer drops names in some cases when `indices` were supplied
...
- `"unique_quiet"` and `"universal_quiet"` are newly accepted by
  ...
  [`vec_interleave()`](https://vctrs.r-lib.org/dev/reference/vec_interleave.md),
  [`vec_rbind()`](https://vctrs.r-lib.org/dev/reference/vec_bind.md),
  and [`vec_cbind()`](https://vctrs.r-lib.org/dev/reference/vec_bind.md)
  ([@jennybc](https://github.com/jennybc),
...
- [`vec_c()`](https://vctrs.r-lib.org/dev/reference/vec_c.md) has gained
...
- The list-of method for
  [`as_list_of()`](https://vctrs.r-lib.org/dev/reference/list_of.md) now
...
- [`vec_c()`](https://vctrs.r-lib.org/dev/reference/vec_c.md),
  [`vec_unchop()`](https://vctrs.r-lib.org/dev/reference/vec_unchop.md),
  and [`vec_rbind()`](https://vctrs.r-lib.org/dev/reference/vec_bind.md)
  now proxy and restore recursively
  ([\#1107](https://github.com/r-lib/vctrs/issues/1107)). This prevents
  [`vec_restore()`](https://vctrs.r-lib.org/dev/reference/vec_proxy.md)
  from being called with partially filled vectors and improves
  performance ([\#1217](https://github.com/r-lib/vctrs/issues/1217),
...
- [`vec_equal_na()`](https://vctrs.r-lib.org/dev/reference/vec_equal_na.md)
  has been renamed to
...
- [`vec_order()`](https://vctrs.r-lib.org/dev/reference/vec_order.md)
  and [`vec_sort()`](https://vctrs.r-lib.org/dev/reference/vec_order.md)
  now have `...` between the required and optional arguments to make
  them easier to extend
...
- The experimental `n` argument of
  [`vec_restore()`](https://vctrs.r-lib.org/dev/reference/vec_proxy.md)
  has been removed. It was only used to inform on the size of data
  frames in case a bare list is restored. It is now expected that bare
  lists be initialised to data frame so that the size is carried through
  row attributes. This makes the generic simpler and fixes some
  performance issues
  ([\#650](https://github.com/r-lib/vctrs/issues/650)).
...
- [`vec_unchop()`](https://vctrs.r-lib.org/dev/reference/vec_unchop.md)
  has been renamed to
  [`list_unchop()`](https://vctrs.r-lib.org/dev/reference/list_unchop.md)
  to better indicate that it requires list input.
  [`vec_unchop()`](https://vctrs.r-lib.org/dev/reference/vec_unchop.md)
  will stick around for a few minor versions, but has been formally
  soft-deprecated
...
- New [`vec_rank()`](https://vctrs.r-lib.org/dev/reference/vec_rank.md)
  to compute various types of sample ranks
...
- [`data_frame()`](https://vctrs.r-lib.org/dev/reference/data_frame.md)
  and [`df_list()`](https://vctrs.r-lib.org/dev/reference/df_list.md)
  have gained `.error_call` arguments
...
- [`vec_rbind()`](https://vctrs.r-lib.org/dev/reference/vec_bind.md) and
  [`vec_cbind()`](https://vctrs.r-lib.org/dev/reference/vec_bind.md) now
  have `.error_call` arguments
  ([\#1597](https://github.com/r-lib/vctrs/issues/1597)).

- [`df_list()`](https://vctrs.r-lib.org/dev/reference/df_list.md) has
  gained a new `.unpack` argument to optionally disable data frame
  unpacking ([\#1616](https://github.com/r-lib/vctrs/issues/1616)).
...
- The `difftime` to `difftime`
  ...
  method now standardizes the internal storage type to double, catching
...
- [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md) now
...
- New experimental
  ...
  [`vec_match()`](https://vctrs.r-lib.org/dev/reference/vec_match.md),
  but returns all matches by default (rather than just the first), and
  can match on binary conditions other than equality. The algorithm is
...
- [`vec_order()`](https://vctrs.r-lib.org/dev/reference/vec_order.md)
  now correctly orders zero column data frames
...
- [`list_of()`](https://vctrs.r-lib.org/dev/reference/list_of.md) is now
...
- [`vec_chop()`](https://vctrs.r-lib.org/dev/reference/vec_chop.md) now
...
- [`vec_ptype()`](https://vctrs.r-lib.org/dev/reference/vec_ptype.md) is
  now an optional *performance* generic. It is not necessary to
  implement, but if your class has a static prototype, you might
  consider implementing a custom
  [`vec_ptype()`](https://vctrs.r-lib.org/dev/reference/vec_ptype.md)
  method that returns a constant to improve performance in some cases
  (such as common type imputation).
...
- New [`vec_unrep()`](https://vctrs.r-lib.org/dev/reference/vec-rep.md)
  to compress a vector with repeated values. It is very similar to run
...
- [`vec_cbind()`](https://vctrs.r-lib.org/dev/reference/vec_bind.md)
  with only empty data frames now preserves the common size of the
  inputs in the result
  ([\#1281](https://github.com/r-lib/vctrs/issues/1281)).

- [`vec_c()`](https://vctrs.r-lib.org/dev/reference/vec_c.md) now
  correctly returns a named result with named empty inputs
...
- Functions that make comparisons within a single vector, such as
  [`vec_unique()`](https://vctrs.r-lib.org/dev/reference/vec_unique.md),
  or between two vectors, such as
  [`vec_match()`](https://vctrs.r-lib.org/dev/reference/vec_match.md),
  now convert all character input to UTF-8 before making comparisons
...
- Fixed an encoding translation bug with lists containing data frames
  ...
  [`vec_size()`](https://vctrs.r-lib.org/dev/reference/vec_size.md) is
...
- [`new_rcrd()`](https://vctrs.r-lib.org/dev/reference/new_rcrd.md) now
  uses [`df_list()`](https://vctrs.r-lib.org/dev/reference/df_list.md)
  to validate the fields. This makes it more flexible as the fields can
  now be of any type supported by vctrs, including data frames.
...
- [`vec_data()`](https://vctrs.r-lib.org/dev/reference/vec_data.md) now
...
- New [`df_list()`](https://vctrs.r-lib.org/dev/reference/df_list.md)
  for safely and consistently constructing the data structure underlying
  a data frame, a named list of equal-length vectors. It is useful in
  combination with
  [`new_data_frame()`](https://vctrs.r-lib.org/dev/reference/new_data_frame.md)
...
- Fixed performance issue with
  [`vec_order()`](https://vctrs.r-lib.org/dev/reference/vec_order.md) on
  classed vectors which affected
  [`dplyr::group_by()`](https://dplyr.tidyverse.org/reference/group_by.html)
  (tidyverse/dplyr#5423).

- [`vec_set_names()`](https://vctrs.r-lib.org/dev/reference/vec_names.md)
  no longer alters the input in-place
...
- New
  ...
  The default method falls through to
  [`vec_proxy_compare()`](https://vctrs.r-lib.org/dev/reference/vec_proxy_compare.md).
...
- [`vec_slice()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md)
  now checks sizes of data frame columns in case the data structure is
...
- [`vec_slice()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md) no
...
- `"Can't convert <character> to <list>."`
  ...
  [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md) no
  longer converts to list. Use
  [`vec_chop()`](https://vctrs.r-lib.org/dev/reference/vec_chop.md) or
...
- Double-dispatch methods for
  ...
  ([\#710](https://github.com/r-lib/vctrs/issues/710)). Class
...
- [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md) is
  now restricted to the same conversions as
  [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
...
- [`stop_incompatible_cast()`](https://vctrs.r-lib.org/dev/reference/vctrs-conditions.md)
  ...
  [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md) also
  throws errors of this class, which better aligns it with
  [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
  now that they are restricted to the same conversions.
...
- Double-dispatch methods for
  [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
  and [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md)
  are now easier to implement. They no longer need any the boiler plate.
...
- [`vec_is_list()`](https://vctrs.r-lib.org/dev/reference/vec_is_list.md)
  no longer allows S3 lists that implement a
  [`vec_proxy()`](https://vctrs.r-lib.org/dev/reference/vec_proxy.md)
...
- [`vec_restore()`](https://vctrs.r-lib.org/dev/reference/vec_proxy.md)
  no longer restores row names if the target is not a data frame. This
...
- [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md) to
  and from data frames preserves the row names of inputs.

- The internal function
  [`vec_names()`](https://vctrs.r-lib.org/dev/reference/vec_names.md)
  now returns row names if the input is a data frame. Similarly,
  [`vec_set_names()`](https://vctrs.r-lib.org/dev/reference/vec_names.md)
...
- Improved support for foreign classes in the combining operations
  ...
  and
  [`vec_unchop()`](https://vctrs.r-lib.org/dev/reference/vec_unchop.md).
  A foreign class is a class that doesn’t implement
  [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md).
...
- [`vec_c()`](https://vctrs.r-lib.org/dev/reference/vec_c.md) and
  [`vec_unchop()`](https://vctrs.r-lib.org/dev/reference/vec_unchop.md)
  now fall back to [`base::c()`](https://rdrr.io/r/base/c.html) for S4
  objects if the object doesn’t implement
  [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
  but sets an S4 [`c()`](https://rdrr.io/r/base/c.html) method
  ([\#919](https://github.com/r-lib/vctrs/issues/919)).

### Vector operations

- [`vec_rbind()`](https://vctrs.r-lib.org/dev/reference/vec_bind.md) and
  [`vec_c()`](https://vctrs.r-lib.org/dev/reference/vec_c.md) with data
...
- [`vec_rbind()`](https://vctrs.r-lib.org/dev/reference/vec_bind.md)
  gains option to treat input names as row names. This is disabled by
  default ([\#966](https://github.com/r-lib/vctrs/issues/966)).

- New [`vec_rep()`](https://vctrs.r-lib.org/dev/reference/vec-rep.md)
  and
  [`vec_rep_each()`](https://vctrs.r-lib.org/dev/reference/vec-rep.md)
  for repeating an entire vector and elements of a vector, respectively.
  These two functions provide a clearer interface for the functionality
  of
  [`vec_repeat()`](https://vctrs.r-lib.org/dev/reference/vec_repeat.md),
  which is now deprecated.

- [`vec_cbind()`](https://vctrs.r-lib.org/dev/reference/vec_bind.md) now
  calls
  [`vec_restore()`](https://vctrs.r-lib.org/dev/reference/vec_proxy.md)
  on inputs emptied of their columns before computing the common type.
  This has consequences for data frame classes with special columns that
...
- [`vec_match()`](https://vctrs.r-lib.org/dev/reference/vec_match.md)
  and [`vec_in()`](https://vctrs.r-lib.org/dev/reference/vec_match.md)
  gain parameters for argument tags
  ([\#944](https://github.com/r-lib/vctrs/issues/944)).

- The internal version of
  [`vec_assign()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md)
  now has support for assigning names and inner names. For data frames,
  the names are assigned recursively.

- [`vec_assign()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md)
  gains `x_arg` and `value_arg` parameters
...
- [`vec_ptype()`](https://vctrs.r-lib.org/dev/reference/vec_ptype.md)
  gained an `x_arg` argument.

- New
  [`list_sizes()`](https://vctrs.r-lib.org/dev/reference/vec_size.md)
  for computing the size of every element in a list.
  [`list_sizes()`](https://vctrs.r-lib.org/dev/reference/vec_size.md) is
  to [`vec_size()`](https://vctrs.r-lib.org/dev/reference/vec_size.md)
  as [`lengths()`](https://rdrr.io/r/base/lengths.html) is to
...
- [`vec_c()`](https://vctrs.r-lib.org/dev/reference/vec_c.md) now
  accepts [`rlang::zap()`](https://rlang.r-lib.org/reference/zap.html)
  as `.name_spec` input. The returned vector is then always unnamed, and
...
- [`new_vctr()`](https://vctrs.r-lib.org/dev/reference/new_vctr.md) now
...
- dplyr methods are now implemented for
  ...
  [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md),
  and [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md).
  The user-visible consequence (and breaking change) is that row-binding
  a grouped data frame and a data frame or tibble now returns a grouped
...
- [`stop_incompatible_type()`](https://vctrs.r-lib.org/dev/reference/vctrs-conditions.md)
  ...
  error came from
  [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
  or [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md).
  [`stop_incompatible_cast()`](https://vctrs.r-lib.org/dev/reference/vctrs-conditions.md)
...
- New argument `loss_type` for the experimental function
  [`maybe_lossy_cast()`](https://vctrs.r-lib.org/dev/reference/maybe_lossy_cast.md).
...
- [`vec_match()`](https://vctrs.r-lib.org/dev/reference/vec_match.md)
  gains an `na_equal` argument
  ([\#718](https://github.com/r-lib/vctrs/issues/718)).

- [`vec_chop()`](https://vctrs.r-lib.org/dev/reference/vec_chop.md)’s
  ...
  aligns
  [`vec_chop()`](https://vctrs.r-lib.org/dev/reference/vec_chop.md) with
  [`vec_unchop()`](https://vctrs.r-lib.org/dev/reference/vec_unchop.md),
  for which only positive integer vectors make sense.
...
- [`vec_c()`](https://vctrs.r-lib.org/dev/reference/vec_c.md) now falls
  back to [`base::c()`](https://rdrr.io/r/base/c.html) if the vector
  doesn’t implement
  [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
  but implements [`c()`](https://rdrr.io/r/base/c.html). This should
  improve the compatibility of vctrs-based functions with foreign
  classes ([\#801](https://github.com/r-lib/vctrs/issues/801)).
...
- [`vec_ptype()`](https://vctrs.r-lib.org/dev/reference/vec_ptype.md)
  now correctly handles unspecified columns in data frames, and will
  always return an unspecified column type
  ([\#800](https://github.com/r-lib/vctrs/issues/800)).

- [`vec_slice()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md)
  and [`vec_chop()`](https://vctrs.r-lib.org/dev/reference/vec_chop.md)
  now work correctly with
  [`bit64::integer64()`](https://bit64.r-lib.org/reference/bit64-package.html)
  objects when an `NA` subscript is supplied. By extension, this means
  that [`vec_init()`](https://vctrs.r-lib.org/dev/reference/vec_init.md)
  now works with these objects as well
...
- New
  ...
  [`vec_as_index()`](https://vctrs.r-lib.org/dev/reference/vec_as_index.md)
  has been renamed to
  [`vec_as_location()`](https://vctrs.r-lib.org/dev/reference/vec_as_location.md).
  Use
  [`num_as_location()`](https://vctrs.r-lib.org/dev/reference/vec_as_location.md)
...
- [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
  ...
  supertypes
  (e.g. [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
  should return the subclass).

  We introduced this breaking change in a patch release because
  [`new_vctr()`](https://vctrs.r-lib.org/dev/reference/new_vctr.md) now
  adds the base type to the class vector by default, which caused
  [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
  to dispatch erroneously to the methods for base types. We’ll finish
...
- [`vec_is()`](https://vctrs.r-lib.org/dev/reference/vec_assert.md) now
  ignores names and row names
  ([\#707](https://github.com/r-lib/vctrs/issues/707)).

- [`vec_slice()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md)
  now support Altvec vectors
...
- [`vec_split()`](https://vctrs.r-lib.org/dev/reference/vec_split.md) no
...
- [`vec_equal()`](https://vctrs.r-lib.org/dev/reference/vec_equal.md) no
...
- Lists of expressions are now supported in
  [`vec_equal()`](https://vctrs.r-lib.org/dev/reference/vec_equal.md)
  and functions that compare elements, such as
  [`vec_unique()`](https://vctrs.r-lib.org/dev/reference/vec_unique.md)
  and
  [`vec_match()`](https://vctrs.r-lib.org/dev/reference/vec_match.md).
  This ensures that they work with the result of modeling functions like
...
- [`new_vctr()`](https://vctrs.r-lib.org/dev/reference/new_vctr.md)
  gains an experimental `inherit_base_type` argument which determines
  whether or not the class of the underlying type will be included in
  the class.

- [`list_of()`](https://vctrs.r-lib.org/dev/reference/list_of.md) now
  inherits explicitly from “list”
  ([\#593](https://github.com/r-lib/vctrs/issues/593)).

- [`vec_ptype()`](https://vctrs.r-lib.org/dev/reference/vec_ptype.md)
  has relaxed default behaviour for base types; now if two vectors both
  inherit from (e.g.) “character”, the common type is also “character”
  ([\#497](https://github.com/r-lib/vctrs/issues/497)).

- [`vec_equal()`](https://vctrs.r-lib.org/dev/reference/vec_equal.md)
  now correctly treats `NULL` as the missing value element for lists
...
- New experimental functions
  ...
  [`vec_group_id()`](https://vctrs.r-lib.org/dev/reference/vec_group.md)
  for constructing group identifiers from a vector;
  [`vec_group_loc()`](https://vctrs.r-lib.org/dev/reference/vec_group.md)
  for computing the locations of unique groups in a vector
  ([\#514](https://github.com/r-lib/vctrs/issues/514)).

- New [`vec_chop()`](https://vctrs.r-lib.org/dev/reference/vec_chop.md)
  for repeatedly slicing a vector. It efficiently captures the pattern
  of `map(indices, vec_slice, x = x)`.

- Support for multiple character encodings has been added to functions
  that compare elements within a single vector, such as
  [`vec_unique()`](https://vctrs.r-lib.org/dev/reference/vec_unique.md),
  and across multiple vectors, such as
  [`vec_match()`](https://vctrs.r-lib.org/dev/reference/vec_match.md).
...
[`vec_c()`](https://vctrs.r-lib.org/dev/reference/vec_c.md) and
[`vec_rbind()`](https://vctrs.r-lib.org/dev/reference/vec_bind.md)
should now be fast enough to be used in packages. This is an ongoing
effort, for instance the handling of factors and dates has not been
rewritten yet. These classes still slow down vctrs primitives.
...
[`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
and [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md)
might need to return a sentinel instead of failing with an error when
there is no common type or possible cast.
...
- [`vec_c()`](https://vctrs.r-lib.org/dev/reference/vec_c.md) now fails
  when an input is supplied with a name but has internal names or is
  length \> 1:
...
- [`vec_empty()`](https://vctrs.r-lib.org/dev/reference/vec_empty.md)
  has been renamed to
...
- `vec_na()` has been renamed to
  [`vec_init()`](https://vctrs.r-lib.org/dev/reference/vec_init.md), as
  the primary use case is to initialize an output container.
...
- We have renamed the `type` particle to `ptype`:
  ...
  - [`vec_type()`](https://vctrs.r-lib.org/dev/reference/vec_type.md)
    =\>
    [`vec_ptype()`](https://vctrs.r-lib.org/dev/reference/vec_ptype.md)
  - [`vec_type2()`](https://vctrs.r-lib.org/dev/reference/vec_type.md)
    =\>
    [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
  - [`vec_type_common()`](https://vctrs.r-lib.org/dev/reference/vec_type.md)
    =\>
    [`vec_ptype_common()`](https://vctrs.r-lib.org/dev/reference/vec_ptype.md)
...
- New
  ...
  [`vec_restore()`](https://vctrs.r-lib.org/dev/reference/vec_proxy.md).
  You should only implement it when your type is designed around a
  ...
  [`vec_proxy()`](https://vctrs.r-lib.org/dev/reference/vec_proxy.md) is
  for S3 lists. In vctrs, S3 lists are treated as scalars by default.
  This way we don’t treat objects like model fits as vectors. To prevent
...
- New [`vec_is()`](https://vctrs.r-lib.org/dev/reference/vec_assert.md)
  function to check whether a vector conforms to a prototype and/or a
  size. Unlike
  [`vec_assert()`](https://vctrs.r-lib.org/dev/reference/vec_assert.md),
  it doesn’t throw errors but returns `TRUE` or `FALSE`
...
- New
  [`vec_order()`](https://vctrs.r-lib.org/dev/reference/vec_order.md)
  and [`vec_sort()`](https://vctrs.r-lib.org/dev/reference/vec_order.md)
  for ordering and sorting generalised vectors.

- New `.names_to` parameter for
  [`vec_rbind()`](https://vctrs.r-lib.org/dev/reference/vec_bind.md). If
...
- [`list_of()`](https://vctrs.r-lib.org/dev/reference/list_of.md) now
  has an [`as.character()`](https://rdrr.io/r/base/character.html)
  method. It uses
  [`vec_ptype_abbr()`](https://vctrs.r-lib.org/dev/reference/vec_ptype_full.md)
...
- [`vec_equal()`](https://vctrs.r-lib.org/dev/reference/vec_equal.md)
  now handles missing values symmetrically
...
- [`vec_size()`](https://vctrs.r-lib.org/dev/reference/vec_size.md) now
...
- [`vec_slice()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md)
  can correct slice 0-row data frames
