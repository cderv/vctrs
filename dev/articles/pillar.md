...
- [`vctrs::vec_ptype_abbr()`](https://vctrs.r-lib.org/dev/reference/vec_ptype_full.md)
...
frames for free. See
[`vignette("s3-vector", package = "vctrs")`](https://vctrs.r-lib.org/dev/articles/s3-vector.md)
